...
class TableRowMarkupTester(unittest.TestCase):
    ...
    def test_left_aligned_cell(self):
        line = TableRowMarkup("|foo |")
        assert line.__html__() == '<tr><td style="text-align:left">foo</td></tr>'
    ...
    def test_center_aligned_cell(self):
        line = TableRowMarkup("| foo |")
        assert line.__html__() == '<tr><td style="text-align:center">foo</td></tr>'

    def test_left_aligned_header_cell(self):
        line = TableRowMarkup("|=foo |")
        assert line.__html__() == '<tr><th style="text-align:left">foo</th></tr>'

    def test_right_aligned_header_cell(self):
        line = TableRowMarkup("|= foo|")
        assert line.__html__() == '<tr><th style="text-align:right">foo</th></tr>'
